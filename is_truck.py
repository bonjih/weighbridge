...
class TruckDetector:
    ...
    def __init__(self, thresh_type, w, h, roi, roi_is_truck, frame_index):
    ...
    def is_truck(self, frame_orig):
        ...
        if self.frame_index > 600:  # adjust to when is_truck / start writing images
            ...
            if len(current_frame_temp[thresh_resized == 255]) > 1000:
                cv2.putText(current_frame_temp, self.roi, (self.roi_is_truck[1][0] - 15, self.roi_is_truck[1][1] - 10),
