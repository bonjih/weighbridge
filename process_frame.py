...
class FrameProcessor:
    ...
    def segment_image(self, raw_frame, frame_index):  # to segment while streaming video
        ...
        if pct < self.segmentation_perc:
            ...
            directions.append(self.directions[frame_index])
        return raw_frame
    ...
    def process_frame(self, raw_frame, prev_frame, frame_height, frame_width, ts, back, frame_index):
        ...
        for roi_key in self.roi_comp.rois:
            ...
            if is_truck:
                ...
                if frame_index % 30 == 0:
                    self.executor.submit(self.segment_image, raw_frame, frame_index)
